        ...
        {products.map((product) => {
          return (
            <Link
              ...
              className="group relative rounded-lg bg-zinc-900 overflow-hidden justify-center items-end"
            >
              <Image
                src={product.image}
          ...
          rounded-full border-2 border-zinc-500 bg-black/60 p-1 pl-5"
              >
                ...
                <span className="flex h-full items-center justi fy-center rounded-full bg-violet-500 px-4 font-semibold">
